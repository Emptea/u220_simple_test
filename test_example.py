...
import test_example_epy_block_0 as epy_block_0  # embedded python block
import test_example_epy_block_0_0 as epy_block_0_0  # embedded python block
...
class test_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_0_0 = epy_block_0_0.blk(sample_rate=samp_rate, frequency=train_freq, duty_cycle=6/232)
        self.epy_block_0 = epy_block_0.blk(sample_rate=samp_rate, frequency=train_freq, duty_cycle=40/232)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_float*1, 141)
        ...
        self.connect((self.epy_block_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0, 0))
        self.connect((self.epy_block_0_0, 0), (self.blocks_delay_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.epy_block_0_0.sample_rate = self.samp_rate
    ...
    def set_train_freq(self, train_freq):
        ...
        self.epy_block_0.frequency = self.train_freq
        self.epy_block_0_0.frequency = self.train_freq
