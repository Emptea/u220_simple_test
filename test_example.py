...
class test_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._freq_0_range = Range(0, 2e9, 50, 10e3, 200)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, freq_0, amp_0, 0, 0)
